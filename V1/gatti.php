 ...
 * Componente React (lista/filtro/selezione) + form prenotazione VanillaJS.
 * Comunicazione React → form tramite CustomEvent.
 */
    ...
    <?php if (!$loggato): ?>
        <aside class="messaggio messaggio-avviso" role="note" aria-label="Avviso accesso">
            <p>
                ...
                Puoi comunque sfogliare e filtrare tutti i gatti.
            </p>
        </aside>
    <?php endif; ?>
