...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($eta === false) $errori[] = 'Età in mesi: numero intero positivo.';
    ...
    if (empty($errori)) {
        try {
            ...
            $stm->execute([$nome,$descrizione,$peso,$colore_mantello,$lunghezza_pelo,$razza,$colore_occhi,$eta,$sesso,$data_arrivo]);
...
stampaTesta('Inserisci nuovo gatto', 'Area riservata: inserisci un nuovo gatto nella struttura.', 'inserisci_gatto.php');
stampaHeader();
apriMain();
?>
...
<section aria-labelledby="titolo-inserisci">
    ...
    <p><strong>Area amministrativa.</strong> Il sistema assegna automaticamente un'immagine placeholder.</p>
    ...
    <form id="form-inserisci-gatto" method="post" action="inserisci_gatto.php"
        ...
        <fieldset>
            ...
            <label for="gatto-nome" class="campo-obbligatorio">
                Nome
                <input type="text" id="gatto-nome" name="nome" required aria-required="true" maxlength="50" placeholder="Es. Fuffi">
            ...
            <label for="gatto-razza" class="campo-obbligatorio">
                Razza
                <input type="text" id="gatto-razza" name="razza" required aria-required="true" maxlength="50" placeholder="Es. Europeo, Persiano">
            ...
            <label for="gatto-eta" class="campo-obbligatorio">
                Età (in mesi)
                <input type="number" id="gatto-eta" name="eta" required aria-required="true" min="0" max="300" placeholder="Es. 24">
        ...
        <fieldset>
            ...
            <label for="gatto-peso" class="campo-obbligatorio">
                Peso (kg)
                <input type="number" id="gatto-peso" name="peso" required aria-required="true" min="0.1" max="20" step="0.01" placeholder="Es. 4.20">
            ...
            <label for="gatto-colore-mantello" class="campo-obbligatorio">
                Colore del mantello
                <input type="text" id="gatto-colore-mantello" name="colore_mantello" required aria-required="true" maxlength="30" placeholder="Es. Tigrato, Bianco">
            ...
            <label for="gatto-colore-occhi" class="campo-obbligatorio">
                Colore degli occhi
                <input type="text" id="gatto-colore-occhi" name="colore_occhi" required aria-required="true" maxlength="30" placeholder="Es. Verdi, Azzurri">
        ...
        <fieldset>
            ...
            <label for="gatto-descrizione" class="campo-obbligatorio">
                ...
                <textarea id="gatto-descrizione" name="descrizione" required aria-required="true"
        ...
        <p class="aiuto-campo">
            <abbr title="Immagine di segnaposto">Placeholder</abbr>: verrà assegnata automaticamente.
            Le foto reali saranno disponibili in una futura versione.
        </p>

        <button type="submit" id="btn-inserisci" class="btn btn-primario">Salva scheda gatto</button>
    </form>
</section>
