 ...
 * Cookie "ricordami" con token opaco (72h). Password mai nel cookie.
 */
        ...
        <fieldset>
            ...
            <label for="username" class="campo-obbligatorio">
                ...
                <input type="text" id="username" name="username"
                       autocomplete="username" value="<?= $usernamePre ?>"
                       required aria-required="true"
                       aria-describedby="aiuto-username" maxlength="50" spellcheck="false">
                <span id="aiuto-username" class="aiuto-campo">Deve iniziare con una lettera.</span>
            ...
            <label for="password" class="campo-obbligatorio">
                ...
                <input type="password" id="password" name="password"
                       autocomplete="current-password" required aria-required="true" maxlength="16">
