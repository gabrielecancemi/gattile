...
(function () {
    ...
    function preparaDati(fasce) {
        ...
        // Dati caricati ma nessun giorno scelto: contenitore pulito (l'invito a
        // scegliere il giorno è già sotto il campo data, niente ridondanza).
        ...
        fetch('api/turni.php', { method: 'POST', body: corpo, credentials: 'same-origin' })
            ...
            .then(function (dati) {
                if (dati.errore) {
                    ...
                    // Prenotazione andata a buon fine: ricarica per riallineare i conteggi.
