...
(function () {
    ...
    function validaUsername() {
        ...
        if (!valore) { mostraErrore(campo_username, errore_username, 'Username: campo obbligatorio.'); return false; }
        if (!/^[a-zA-Z]/.test(valore)) { mostraErrore(campo_username, errore_username, 'Username: deve iniziare con una lettera.'); return false; }
        mostraErrore(campo_username, errore_username, ''); return true;
    }

    function validaPassword() {
        if (!campo_password || !campo_password.value) { mostraErrore(campo_password, errore_password, 'Password: campo obbligatorio.'); return false; }
