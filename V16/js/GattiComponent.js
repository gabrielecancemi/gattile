...
(function () {
  ...
  function GattiApp({
    ...
    return /*#__PURE__*/React.createElement("section", {
      ...
      className: "sr-solo",
      role: "status"
    }, gatti_visibili.length === gatti.length ? gatti.length + ' gatti disponibili.' : gatti_visibili.length + ' gatti trovati su ' + gatti.length + '.', selezionati.size > 0 ? ' ' + selezionati.size + ' selezionati.' : ''), utenteLoggato && /*#__PURE__*/React.createElement("p", {
