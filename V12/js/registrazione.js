...
(function () {
    ...
    function validaInd() { let v = campi.indirizzo.input ? campi.indirizzo.input.value.trim() : ''; if (v.length < 5) { mostraErrore(campi.indirizzo, 'Almeno 5 caratteri.'); return false; } mostraErrore(campi.indirizzo, ''); return true; }
