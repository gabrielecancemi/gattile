...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strlen($indirizzo) < 5)  $errori[] = 'Inserisci un indirizzo valido (min. 5 caratteri).';
...
<section aria-labelledby="titolo-registrazione">
    ...
    <?php if (!$successo): ?>
    <form id="form-registrazione" method="post" action="registrazione.php"
          novalidate aria-label="Modulo di registrazione">
        ...
        <fieldset>
            ...
            <label for="reg-nome" class="campo-obbligatorio">
                ...
                <b class="errore-campo" id="err-nome" role="alert" aria-live="polite" hidden></b>
            </label>

            <label for="reg-cognome" class="campo-obbligatorio">
                Cognome
                <input type="text" id="reg-cognome" name="cognome"
                       value="<?= esc($campi['cognome']) ?>"
                       autocomplete="family-name" required aria-required="true" maxlength="50">
                <b class="errore-campo" id="err-cognome" role="alert" aria-live="polite" hidden></b>
            </label>

            <label for="reg-indirizzo" class="campo-obbligatorio">
                Indirizzo
                <input type="text" id="reg-indirizzo" name="indirizzo"
                ...
                <b class="errore-campo" id="err-indirizzo" role="alert" aria-live="polite" hidden></b>
            </label>
        </fieldset>
        ...
        <fieldset>
            ...
            <label for="reg-username" class="campo-obbligatorio">
                ...
                <b class="errore-campo" id="err-reg-username" role="alert" aria-live="polite" hidden></b>
            </label>
            ...
            <label for="reg-password" class="campo-obbligatorio">
                ...
                <b class="errore-campo" id="err-reg-password" role="alert" aria-live="polite" hidden></b>
            ...
            <label for="reg-conferma" class="campo-obbligatorio">
                ...
                <input type="password" id="reg-conferma" name="conferma_password"
                       autocomplete="new-password" required aria-required="true"
                       minlength="8" maxlength="16">
                <b class="errore-campo" id="err-reg-conferma" role="alert" aria-live="polite" hidden></b>
            </label>
        </fieldset>
