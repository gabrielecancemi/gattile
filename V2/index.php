<?php
/**
 * index.php — Home page di Gattile Felice.
...
stampaTesta(
    'Benvenuto',
    'Gattile Felice: adotta un gatto o diventa volontario a Torino. Scopri i nostri ospiti felini.',
    'index.php'
);
stampaHeader();
apriMain();
                ...
                <article class="card-gatto" aria-labelledby="nuovo-<?= (int)$gatto['id'] ?>">
                    ...
                    <section class="card-gatto-corpo">
                        <h3 id="nuovo-<?= (int)$gatto['id'] ?>">
                            <?= esc($gatto['nome']) ?>
                            <b class="badge-nuovo" aria-label="Nuovo arrivo">Nuovo</b>
                        </h3>
