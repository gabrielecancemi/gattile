...
/**
 * Crea un token casuale (64 caratteri esadecimali) e lo salva nel cookie
 * e nella sessione PHP. Il cookie contiene solo il token, mai le credenziali.
 * Il mapping token → username è tenuto in sessione lato server.
 */
