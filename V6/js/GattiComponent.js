...
(function () {
  ...
  function CardGatto({
    ...
    return /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("article", {
      ...
      "aria-label": gatto.nome + (selezionabile ? selezionata ? ' — selezionato' : ' — clicca per selezionare' : '')
      ...
      className: "sr-solo"
    }, "Placeholder foto per ", gatto.nome)), /*#__PURE__*/React.createElement("section", {
      className: "card-gatto-corpo"
    }, /*#__PURE__*/React.createElement("h3", null, gatto.nome), /*#__PURE__*/React.createElement("ul", {
