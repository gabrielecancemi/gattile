        ...
        <div class="privacy-contenuto">
            ...
            <article class="privacy-blocco" id="sez-dati" aria-labelledby="h-dati">
                ...
                <p>
                    ...
                    La password non è mai conservata in chiaro: viene salvato solo il suo
                    digest <abbr title="Secure Hash Algorithm a 256 bit">SHA-256</abbr>
                    calcolato con un <em>salt</em> unico per ogni utente, quindi non è
                    leggibile dal personale. I dati non vengono ceduti a terzi.
                </p>
            </article>
